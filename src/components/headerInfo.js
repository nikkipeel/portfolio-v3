...
function HeaderInfo() {
  ...
  <div className="flex flex-col xl:w-1/2 justify-center items-center mx-auto xl:ml-36">
    <img className="h-60 w-52 shadow-inner" src={selfie} alt="portrait" style={{borderRadius: '50%', filter: 'contrast(110%)'}}/>
    ...
    <div className="card flex flex-col text-center bg-white text-indigo rounded-sm shadow-xl w-full xl:w-2/3 px-12 py-4 my-8">
      ...
      <a href="#"className="text-indigo uppercase font-bold hover:underline mt-2" style={{textShadow: '-1.5px 1.5px 0px #40C69F', textUnderlineOffset: '3px'}}>Download Resume</a>
        <div className="mt-4">
